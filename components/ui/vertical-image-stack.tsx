...
const images = [
  ...
  {
    id: 4,
    src: "https://images.unsplash.com/photo-1519451241324-20b4ea2c4220?q=80&w=800&auto=format&fit=crop",
    alt: "Coastal village sunset",
  },
  {
    id: 5,
...
export function VerticalImageStack() {
  ...
  const navigate = useCallback((newDirection: number) => {
    ...
    setCurrentIndex((prev) => {
      if (newDirection > 0) return prev === images.length - 1 ? 0 : prev + 1;
